...
SPOOL /Users/jakub_kaminski03/documents/studia/Benchmark_All_Indexes_Results.txt


-- B-tree indexes
CREATE INDEX idx_activities_runner_id
ON Activities(runner_id);

CREATE INDEX idx_telemetry_activity_id
ON Telemetry_Data(activity_id);

-- Bitmap index
CREATE BITMAP INDEX idx_activities_type
ON Activities(activity_type);

-- Function-based index
CREATE INDEX idx_activity_year
ON Activities(EXTRACT(YEAR FROM activity_date));
